<template>
  <div class="update">
    <v-breadcrumbs divider="-">
      ...
      <v-breadcrumbs-item>Atualizar Cliente</v-breadcrumbs-item>
    </v-breadcrumbs>
    <h1 class="text-left my-4">Atualizar Cliente</h1>
    <v-progress-linear
      v-if="loading.includes(true) || submitting"
      indeterminate
      color="cyan"
    ></v-progress-linear>
      ...
      <v-stepper-items>
        ...
        <v-stepper-content step="3">
          ...
          <v-btn
            ...
            :disabled="submitting"
          >
            <v-icon class="mr-2">mdi-account-edit</v-icon> Atualizar
          </v-btn>
    ...
    async getCustomer(id: string | number) {
      try {
        ...
        if(this.customer != null) {
          ...
          this.salary = this.customer.salary;
          this.address = this.customer.address;
          this.addressNumber = this.customer.addressNumber;
          this.addressComplement = this.customer.addressComplement;
          this.addressDistrict = this.customer.addressDistrict;
          this.addressCity = this.customer.addressCity;
          this.addressZipcode = this.customer.addressZipcode;
